 ...
 * {@link DrillDownEvent} events.
 *
 * @author Rinat Enikeev (rinat.enikeev[at]gmail[dot]com)
 * @version %I%, %G%
 * @since 1.0
 */
public interface HasDrillDownHandlers<T> extends HasHandlers {
     ...
     */
    HandlerRegistration addDrillDownHandler(DrillDownEvent.Handler<T> handler);
}
