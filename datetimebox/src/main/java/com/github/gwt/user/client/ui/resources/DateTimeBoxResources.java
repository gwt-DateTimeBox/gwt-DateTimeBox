 ...
 * @since 1.0
 */
public interface DateTimeBoxResources extends ClientBundle {

    DateTimeBoxButtonResources calButton();

    @Source("com/github/gwt/user/client/ui/css/DateTimeBox.css")
    Style style();
