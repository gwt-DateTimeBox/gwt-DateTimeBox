 ...
 * @since 1.0
 */
public class HoursGridResourcesImpl {
     ...
     * .hours.resources.HoursGridResourcesImpl"/>
     * </replace-with>
     */
    public static final HoursGridResourcesStub impl
            = GWT.create(HoursGridResourcesStub.class);

    public static HoursGridResources hoursGridResources() {
        return impl.getHoursGridResources();
    }
