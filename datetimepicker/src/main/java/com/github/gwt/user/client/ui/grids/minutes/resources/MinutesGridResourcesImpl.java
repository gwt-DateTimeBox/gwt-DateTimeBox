 ...
 * @since 1.0
 */
public class MinutesGridResourcesImpl {
     ...
     * .,minutes.resources.MinutesGridResourcesImpl"/>
     * </replace-with>
     */
    public static final MinutesGridResourcesStub impl
            = GWT.create(MinutesGridResourcesStub.class);

    public static MinutesGridResources minutesGridResources() {
        return impl.getMinutesGridResources();
    }
