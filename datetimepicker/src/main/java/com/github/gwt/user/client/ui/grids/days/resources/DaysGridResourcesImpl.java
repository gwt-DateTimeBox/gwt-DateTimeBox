...
/**
 * {@link com.github.gwt.user.client.ui.grids.days.DaysGrid} resources.
 ...
 * @since 1.0
 */
public class DaysGridResourcesImpl {
     ...
     * <when-type-is class=
     * com.github.gwt.user.client.ui.grids
     * .days.resources.DaysGridResourcesImpl"/>
     * </replace-with>
     */
    public static final DaysGridResourcesStub impl
            = GWT.create(DaysGridResourcesStub.class);

    public static DaysGridResources daysGridResources() {
        return impl.getDaysGridResources();
    }
