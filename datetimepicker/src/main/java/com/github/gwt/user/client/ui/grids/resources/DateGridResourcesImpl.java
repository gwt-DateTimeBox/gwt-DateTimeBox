 ...
 * @since 1.0
 */
public class DateGridResourcesImpl {
     ...
     * .resources.DateGridResourcesImpl"/>
     * </replace-with>
     */
    public static final DateGridResourcesStub impl
            = GWT.create(DateGridResourcesStub.class);

    public static DateGridResources dateGridResources() {
        return impl.getDateGridResources();
    }
